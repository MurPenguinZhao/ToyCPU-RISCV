...
HD_PWD='D:/Study_in_2022_Spring/Computer_System/Lab_Project/Lab2/Lab2.runs/D_BRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_BRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_BRAM.tcl
